...
// page. en / zh-CN / zh-TW are added translations.
const I18N = {
  "nav.home": { ja: "Home", en: "Home", "zh-CN": "首页", "zh-TW": "首頁" },
  "nav.portfolio": { ja: "Portfolio", en: "Portfolio", "zh-CN": "作品集", "zh-TW": "作品集" },
  "nav.contact": { ja: "Contact", en: "Contact", "zh-CN": "联系方式", "zh-TW": "聯絡方式" },

  "hero.eyebrow": { ja: "CG · Illustration · Animation", en: "CG · Illustration · Animation", "zh-CN": "CG · Illustration · Animation", "zh-TW": "CG · Illustration · Animation" },
  "hero.desc": {
  ...
  "hero.viewPortfolio": { ja: "View Portfolio", en: "View Portfolio", "zh-CN": "查看作品集", "zh-TW": "查看作品集" },
  "hero.aboutMe": { ja: "About Me", en: "About Me", "zh-CN": "关于我", "zh-TW": "關於我" },
  ...
  "about.fieldHeading": { ja: "現在の研究分野", en: "Current Field of Study", "zh-CN": "目前的研究领域", "zh-TW": "目前的研究領域" },
  "about.fieldBody": {
  ...
  "about.goalHeading": { ja: "目標", en: "Goal", "zh-CN": "目标", "zh-TW": "目標" },
  "about.goalBody1": {
  ...
  "skills.heading": { ja: "Skills", en: "Skills", "zh-CN": "Skills", "zh-TW": "Skills" },

  "contact.eyebrow": { ja: "Contact", en: "Contact", "zh-CN": "Contact", "zh-TW": "Contact" },
  "contact.heading": { ja: "一緒に何か作りませんか", en: "Let's Create Something Together", "zh-CN": "一起创作些什么吧", "zh-TW": "一起創作些什麼吧" },
  "contact.body": {
  ...
  "works.videoHeading": { ja: "映像作品", en: "Video Works", "zh-CN": "影像作品", "zh-TW": "影像作品" },
  "works.videoDesc": {
  ...
  "video.sword.sub": { ja: "3D / 2D アニメーション作品", en: "3D / 2D Animation", "zh-CN": "3D / 2D 动画作品", "zh-TW": "3D / 2D 動畫作品" },
  "video.sunflower.sub": { ja: "手描き 2D アニメーション", en: "Hand-drawn 2D Animation", "zh-CN": "手绘 2D 动画", "zh-TW": "手繪 2D 動畫" },
  "video.soul.sub": { ja: "CG アニメーション", en: "CG Animation", "zh-CN": "CG 动画", "zh-TW": "CG 動畫" },
  "video.abyss.sub": { ja: "CG ショートフィルム", en: "CG Short Film", "zh-CN": "CG 短片", "zh-TW": "CG 短片" },
  "video.honda.sub": { ja: "CG映像制作", en: "CG Production", "zh-CN": "CG 影像制作", "zh-TW": "CG 影像製作" },
  "video.cyber.sub": { ja: "3D CG アニメーション", en: "3D CG Animation", "zh-CN": "3D CG 动画", "zh-TW": "3D CG 動畫" },

  "works.processHeading": { ja: "制作プロセス", en: "Process", "zh-CN": "制作流程", "zh-TW": "製作流程" },
  "works.processDesc": {
  ...
  "step.ideaSketch": { ja: "アイデアスケッチ", en: "Idea Sketch", "zh-CN": "构思草图", "zh-TW": "構思草圖" },
  "step.modeling": { ja: "モデリング", en: "Modeling", "zh-CN": "建模", "zh-TW": "建模" },
  "step.uvUnwrap": { ja: "UV 展開", en: "UV Unwrapping", "zh-CN": "UV 展开", "zh-TW": "UV 展開" },
  "step.texturing": { ja: "テクスチャ制作", en: "Texturing", "zh-CN": "贴图制作", "zh-TW": "貼圖製作" },
  "step.artConcept": { ja: "アートコンセプト", en: "Art Concept", "zh-CN": "美术概念稿", "zh-TW": "美術概念稿" },
  "step.zbrushSculpt": { ja: "ZBrush 彫刻", en: "ZBrush Sculpting", "zh-CN": "ZBrush 雕刻", "zh-TW": "ZBrush 雕刻" },

  // 望遠鏡 (Telescope)
  "proj.telescope.eyebrow": { ja: "プロップデザイン", en: "Prop Design", "zh-CN": "道具设计", "zh-TW": "道具設計" },
  "proj.telescope.lede": {
  ...
  // ABYSS II
  "proj.abyss.eyebrow": { ja: "CG ショートフィルム", en: "CG Short Film", "zh-CN": "CG 短片", "zh-TW": "CG 短片" },
  "proj.abyss.lede": {
  ...
  "proj.abyss.s1.title": { ja: "参考資料とイメージボード", en: "Reference & Image Board", "zh-CN": "参考资料与意向图", "zh-TW": "參考資料與意象圖" },
  "proj.abyss.s1.desc": {
  ...
  "proj.abyss.s2.title": { ja: "人物モデリング", en: "Character Modeling", "zh-CN": "人物建模", "zh-TW": "人物建模" },
  "proj.abyss.s2.desc": {
  ...
  "proj.abyss.s3.title": { ja: "主体物モデリング", en: "Statue Modeling", "zh-CN": "主体石像建模", "zh-TW": "主體石像建模" },
  "proj.abyss.s3.desc": {
  ...
  "proj.abyss.s4.title": { ja: "岩石モデリング・彫刻", en: "Rock Modeling & Sculpting", "zh-CN": "岩石建模与雕刻", "zh-TW": "岩石建模與雕刻" },
  "proj.abyss.s4.desc": {
  ...
  "proj.abyss.s5.title": { ja: "UE5 シーン配置", en: "UE5 Scene Layout", "zh-CN": "UE5 场景布置", "zh-TW": "UE5 場景佈置" },
  "proj.abyss.s5.desc": {
  ...
  "proj.abyss.s6.title": { ja: "ライティングと仕上げ", en: "Lighting & Finishing", "zh-CN": "灯光与最终润色", "zh-TW": "燈光與最終潤飾" },
  "proj.abyss.s6.desc": {
  ...
  // Honda CIVIC
  "proj.honda.eyebrow": { ja: "CG映像制作", en: "CG Production", "zh-CN": "CG 影像制作", "zh-TW": "CG 影像製作" },
  "proj.honda.lede": {
  ...
  "proj.honda.s1.title": { ja: "モデリングと UV 展開", en: "Modeling & UV Unwrapping", "zh-CN": "建模与 UV 展开", "zh-TW": "建模與 UV 展開" },
  "proj.honda.s1.desc": {
  ...
  "proj.honda.s3.title": { ja: "背景とライティング", en: "Environment & Lighting", "zh-CN": "场景与灯光", "zh-TW": "場景與燈光" },
  "proj.honda.s3.desc": {
  ...
  "proj.honda.s4.title": { ja: "レンダリングと編集", en: "Rendering & Editing", "zh-CN": "渲染与剪辑", "zh-TW": "渲染與剪輯" },
  "proj.honda.s4.desc": {
  ...
  "proj.char.s1.title": { ja: "三面図と設定", en: "Turnaround & Design Sheet", "zh-CN": "三视图与设定", "zh-TW": "三視圖與設定" },
  "proj.char.s1.desc": {
  ...
  // gallery
  "works.galleryHeading": { ja: "作品一覧", en: "Works", "zh-CN": "作品一览", "zh-TW": "作品一覽" },
  "works.galleryDesc": {
  ...
  "gallery.g1.title": { ja: "水彩画", en: "Watercolor", "zh-CN": "水彩画", "zh-TW": "水彩畫" },
  "gallery.g1.desc": {
  ...
  "gallery.g2.title": { ja: "色鉛筆画", en: "Colored Pencil", "zh-CN": "彩色铅笔画", "zh-TW": "彩色鉛筆畫" },
  "gallery.g2.desc": {
  ...
  "gallery.g3.title": { ja: "デジタルペイント", en: "Digital Painting", "zh-CN": "数字绘画", "zh-TW": "數位繪畫" },
  "gallery.g3.desc": {
  ...
  "gallery.g4.title": { ja: "鉛筆デッサン", en: "Pencil Dessin", "zh-CN": "铅笔素描", "zh-TW": "鉛筆素描" },
  "gallery.g4.desc": {
...
(function () {
  ...
  const SUPPORTED = ["ja", "en", "zh-CN", "zh-TW"];
  const NATIVE_NAME = { ja: "日本語", en: "English", "zh-CN": "简体中文", "zh-TW": "繁體中文" };
